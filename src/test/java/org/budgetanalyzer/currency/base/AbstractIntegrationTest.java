 ...
 *   <li>Claims-header-based authentication via {@code ClaimsHeaderTestBuilder}
 * </ul>
 *
 ...
 * </ul>
 *
 * <p><b>Authentication in Tests:</b>
 *
 * <p>Authentication is set per-request using {@code ClaimsHeaderTestBuilder} as a MockMvc {@code
 * RequestPostProcessor}. Subclasses that use MockMvc should pass {@code ClaimsHeaderTestBuilder}
 * instances via {@code .with()} on each request.
 *
 * <p><b>Usage:</b>
 *
 * <pre>{@code
 ...
 * @see org.budgetanalyzer.service.security.test.ClaimsHeaderTestBuilder
...
public abstract class AbstractIntegrationTest {
  ...
  // Authentication is handled per-request via ClaimsHeaderTestBuilder
